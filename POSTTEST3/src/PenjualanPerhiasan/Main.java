...
public class Main {
    ...
    public static void tambahPerhiasan() {
        ...
        if (pilih == 1) {
            ...
            System.out.print("Kadar emas: ");
            double kadar = Double.parseDouble(input.nextLine());

            daftarPerhiasan.add(new Emas(id, nama, harga, stok, kadar));

        } else if (pilih == 2) {

            System.out.print("Kualitas perak: ");
            String kualitas = input.nextLine();

            daftarPerhiasan.add(new Perak(id, nama, harga, stok, kualitas));

        } else if (pilih == 3) {

            System.out.print("Karat berlian: ");
            int karat = Integer.parseInt(input.nextLine());

            daftarPerhiasan.add(new Berlian(id, nama, harga, stok, karat));
    ...
    public static void tampilPerhiasan() {
        ...
        for (Perhiasan p : daftarPerhiasan) {
            ...
            // tambahan inheritance (polymorphism)
            p.displayInfo();
        }
    }
